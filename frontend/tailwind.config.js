  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        "rice-paper": "#F8F5F2", // 柔和的米白/宣纸色
        "charcoal": "#343434", // 深炭灰色
        "indigo-dye": "#2E4057", // 靛蓝色
        "moonlight": "#A7B0CA", // 月光/辅助灰色
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      fontFamily: {
        ...
        'noto-sc': ["var(--font-noto-sans-sc)", ...fontFamily.sans],
        'calligraphy': ["var(--font-ma-shan-zheng)", ...fontFamily.serif],
      },
      backgroundImage: {
